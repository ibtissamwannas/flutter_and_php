...
class _EditNoteState extends State<EditNote> with Crud {
  ...
  EditNote() async {
    if (formstate.currentState!.validate()) {
      var res;
      if (myfile == null) {
        print(widget.notes['image'].toString());
        res = await postRequest(edit, {
          "title": notetitle.text,
          "content": noteContent.text,
          "noteid": widget.notes['id'].toString(),
  ...
  @override
  void initState() {
    notetitle.text = widget.notes['title'];
    noteContent.text = widget.notes['content'];
